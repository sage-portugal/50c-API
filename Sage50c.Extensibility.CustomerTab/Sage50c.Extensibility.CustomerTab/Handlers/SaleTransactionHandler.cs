...
namespace Sage50c.Extensibility.CustomerTab.Handlers.SaleTransactionHandler
{
    class SaleTransactionHandler : IDisposable
    {
        ...
        private FormSaleTransactionTab  _formTab = null;                     //Form das propriedades
        ...
        void myEvents_OnMenuItem(object Sender, ExtenderEventArgs e)
        {
            ...
            switch (menuId)
            {
                case "mniXItemTransaction1":
                    System.Windows.Forms.MessageBox.Show("Pressionei  SaleTransaction 1");
                    break;

                case "mniXItemTransaction2":
                    System.Windows.Forms.MessageBox.Show("Pressionei  SaleTransaction 2");
                    break;
            }
        }
        ...
        void myEvents_OnInitialize(object Sender, ExtenderEventArgs e)
        {
            ...
            if (propertyList.PropertyExists("IManagementConsole"))
            {
                ...
                _formTab = new FormSaleTransactionTab();
